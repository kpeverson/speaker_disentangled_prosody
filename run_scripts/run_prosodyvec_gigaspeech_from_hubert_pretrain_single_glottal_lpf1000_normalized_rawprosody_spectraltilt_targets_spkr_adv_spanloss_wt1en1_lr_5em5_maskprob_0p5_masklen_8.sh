...
pretrained_hubert_path=/path/to/pretrained_hubert/hubert_base_ls960.pt
...
HYDRA_FULL_ERROR=1 python -u ${prosodyvec_dir}/fairseq/fairseq_cli/hydra_train.py  \
    ...
    --config-name prosodyvec_raw_prosody_gigaspeech_spkr_adv_spanloss_lr_5em5_manual_mask_pretrained_hubert_large_batch \
    ...
    model.mask_prob=0.5 \
    model.mask_length=8 \
    model.pretrained_encoder=${pretrained_hubert_path} \
